...
export default function Footer({ backgroundColor = "default" }) {
  ...
  // Decide what background to actually use
  const resolveBackground = () => {
    // If a specific color was passed in, always respect that
    if (backgroundColor !== "default") {
      return backgroundColor;
    }

    // Route-based background overrides
    // Maroon footer on Who We Are + all Scholarships routes
    if (
    ...
    // Default footer color everywhere else
    return "default";
  };

  const effectiveBackground = resolveBackground();
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-left mb-6 md:mb-0">
            ...
            <p>
              © {new Date().getFullYear()} Zonta Club of Naples. All Rights
              Reserved.
            </p>
          </div>
