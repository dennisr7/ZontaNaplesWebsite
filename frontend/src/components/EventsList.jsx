...
function EventsList() {
    ...
    if (loading) {
        return (
            <div className="w-full flex justify-center items-center min-h-[300px]">
                <div className="bg-white/95 backdrop-blur rounded-2xl shadow-xl px-8 py-4 text-zonta-burgundy text-lg font-semibold">
                    Loading events...
                </div>
            </div>
        );
    ...
    return (
        <div className="w-full">
            {/* TRANSPARENT WRAPPER (was previously white bubble) */}
            <div className="bg-transparent shadow-none backdrop-blur-none p-8">
                
                <div className="mb-12">
                    <div className="text-center mb-8">
                        <h2 className="text-4xl font-bold text-zonta-burgundy mb-4">
                            Upcoming Events
                        </h2>
                        ...
                        {events.map(event => (
                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col flex-grow">
                                    ...
                                    <h3 className="text-xl font-bold text-zonta-burgundy mb-2 line-clamp-2 min-h-[3.5rem]">
                                        {event.title}
                                    </h3>
