            ...
            <aside className="w-64 bg-zonta-burgundy text-white fixed h-full shadow-xl">
                ...
                <nav className="mt-6">
                    ...
                    <Link
                        ...
                        className={`flex items-center px-6 py-3 hover:bg-zonta-burgundy-dark transition-colors duration-200 ${
                            location.pathname === '/admin/scholarships' || location.pathname.startsWith('/admin/scholarships/') ? 'bg-zonta-burgundy-dark border-l-4 border-zonta-gold' : ''
                        }`}
                    >
                        <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link
                        to="/admin/scholarship-listings"
                        className={`flex items-center px-6 py-3 hover:bg-zonta-burgundy-dark transition-colors duration-200 ${
                            location.pathname.includes('/admin/scholarship-listings') ? 'bg-zonta-burgundy-dark border-l-4 border-zonta-gold' : ''
                        }`}
                    >
                        <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
