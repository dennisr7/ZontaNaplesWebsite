...
const Shop = () => {
  ...
  // Loading state with gradient + proper padding
  if (loading) {
    return (
      <main className="relative min-h-screen pt-32 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="mt-4 text-white/90">Loading products...</p>
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="relative min-h-screen pt-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Gradient background to match other pages */}
      <div className="absolute inset-0 bg-gradient-to-b from-yellow-600/80 via-yellow-700/70 to-red-900/90" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto pb-16">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto">
            Support our mission by purchasing Zonta merchandise. All proceeds
            benefit our programs.
          </p>
        </div>

        {/* Transparent wrapper – white bubble removed */}
        <div className="p-6 sm:p-8">
          ...
          {filteredProducts.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-white/90 text-lg">No products found</p>
            </div>
          ) : (
