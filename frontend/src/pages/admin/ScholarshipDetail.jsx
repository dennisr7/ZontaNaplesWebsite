...
function ScholarshipDetail() {
    usePageTitle('Admin - Scholarship Details');
    const { id } = useParams();
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-zonta-burgundy">
                    ...
                    <div className="space-y-4">
                        {/* Scholarship Listing Information */}
                        {scholarship.scholarshipListingId && (
                            <div className="flex items-start gap-3">
                            <svg className="w-5 h-5 text-zonta-gold flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
                            <div className="flex-1">
                                <label className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Scholarship</label>
                                <p className="text-lg font-medium text-gray-800">
                                    {scholarship.scholarshipListingId.title}
                                </p>
                            </div>
                        </div>
                        )}
